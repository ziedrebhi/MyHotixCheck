        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (signatureBitmap != null) {
                    Log.i(TAG, "Not Null" + String.valueOf(signatureBitmap.getByteCount()));
                }
                encodedSignature = getBase64ImageString(signatureBitmap);


           //     byte[] decodedString = Base64.decode(encodedSignature, Base64.URL_SAFE | Base64.NO_WRAP);
             //   Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);

//                ImageView image = new ImageView(SignatureActivity.this);
...
//                builder.create().show();
                ...
                b.putString("image", encodedSignature);
