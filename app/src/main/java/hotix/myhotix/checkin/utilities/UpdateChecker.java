...
public class UpdateChecker {
    ...
    private DownloadManager downloadManager = new DownloadManager(mContext, false);
                ...
                if (versionCode >= 0) {
                    try {
                        ...
                        if (readCode > versionCode) {
                            ...
                            Log.i("Update",String.valueOf(readCode));
    ...
    public boolean isUpdateAvailable() {
        Log.i("updateAvailable", String.valueOf(updateAvailable));
